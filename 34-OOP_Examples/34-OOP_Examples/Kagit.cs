...
{
    public abstract class Kagit
    {
        // 1. YÖNTEM 
        public virtual int Yukseklik { get; }
        public virtual int Genislik { get; }


        // 2. YÖNTEM 

        //public int Genislik { get; protected set; }    // property    -- Kağıt boyut standardı olduğu için set olmayacak
        //public int Yukseklik { get; protected set; }   // property
